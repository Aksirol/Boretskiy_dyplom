...
class Room(Base):
    ...
    workplaces = relationship("Workplace", back_populates="room")
...
class Workplace(Base):
    ...
    computers = relationship("Computer", back_populates="workplace")
    peripherals = relationship("Peripheral", back_populates="workplace")
...
class ComputerType(Base):
    ...
    computers = relationship("Computer", back_populates="computer_type")
...
class PeripheralType(Base):
    ...
    peripherals = relationship("Peripheral", back_populates="peripheral_type")
